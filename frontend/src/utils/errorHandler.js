...
class ErrorHandler {
  ...
  handleAuthError(error, showToast = true) {
    ...
    // DO NOT automatically clear auth data or redirect
    // This prevents unwanted logouts when non-critical APIs fail
    // Only clear auth on explicit logout or critical auth failures
