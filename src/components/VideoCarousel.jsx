  ...
  return (
    <section className="py-16 bg-background">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-display font-bold text-foreground text-center mb-3">Video Stories</h2>
        <p className="text-muted-foreground text-center mb-10">Watch our couples share their beautiful love stories</p>
