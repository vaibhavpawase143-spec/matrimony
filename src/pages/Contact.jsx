      ...
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              { icon: <Phone className="h-5 w-5" />, title: "Phone", detail: "+91 8999823244", sub: "Mon–Sat, 9am–6pm" },
              { icon: <Mail className="h-5 w-5" />, title: "Email", detail: "dhawalepriyanka16@gmail.com", sub: "We reply within 24hrs" },
              { icon: <MapPin className="h-5 w-5" />, title: "Office", detail: "Sangamner college sangamner", sub: "Maharashtra, India" },
            ].map((c) => (
