  ...
  return (
    <div className="min-h-screen bg-muted/30">
      ...
      <div className="py-8 text-center" style={{ background: "linear-gradient(135deg, hsl(270 60% 35%), hsl(290 55% 45%), hsl(270 50% 55%))" }}>
        ...
        <h1 className="text-3xl md:text-4xl font-display font-bold text-primary-foreground mb-2">Kundli Matching</h1>
        <p className="text-primary-foreground/70 text-sm">Check compatibility based on Ashtakoot Gun Milan</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div className="bg-card rounded-xl border border-border p-6">
            ...
            <div className="space-y-3">
              <InputField label="Full Name" placeholder="Enter boy's name" />
              <InputField label="Date of Birth" placeholder="" type="date" />
              <InputField label="Time of Birth" placeholder="" type="time" />
              <InputField label="Place of Birth" placeholder="Enter city" />
            </div>
          </div>
          ...
          <div className="bg-card rounded-xl border border-border p-6">
            ...
            <div className="space-y-3">
              <InputField label="Full Name" placeholder="Enter girl's name" />
              <InputField label="Date of Birth" placeholder="" type="date" />
              <InputField label="Time of Birth" placeholder="" type="time" />
              <InputField label="Place of Birth" placeholder="Enter city" />
            </div>
        ...
        {showResult && (
          <div className="max-w-3xl mx-auto mt-8 space-y-6">
            ...
            <div className="bg-card rounded-xl border border-border p-8 text-center">
              <h2 className="text-lg font-display font-bold text-foreground mb-4">Match Result</h2>
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                <span className="text-sm font-semibold text-foreground">
                  {percentage >= 70 ? "Excellent Match!" : percentage >= 50 ? "Good Match" : "Average Match"}
                </span>
              </div>
            </div>
            ...
            {/* Detailed breakdown */}
            <div className="bg-card rounded-xl border border-border p-6">
              <h3 className="text-sm font-semibold text-foreground mb-4">Ashtakoot Details</h3>
