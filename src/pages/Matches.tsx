...
const Matches = () => (
  <div className="min-h-screen bg-muted/30">
    ...
    <div className="py-8 text-center" style={{ background: "linear-gradient(135deg, hsl(270 60% 35%), hsl(290 55% 45%), hsl(270 50% 55%))" }}>
      ...
      <h1 className="text-3xl md:text-4xl font-display font-bold text-primary-foreground mb-2">Your Matches</h1>
      <p className="text-primary-foreground/70 text-sm">Profiles matched based on your preferences</p>
    </div>
