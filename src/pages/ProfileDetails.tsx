...
const allProfiles: Record<string, { name: string; age: number; city: string; religion: string; education: string; profession: string; image: string; height: string; caste: string; motherTongue: string; about: string; familyType: string; fatherOccupation: string; siblings: string }> = {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="bg-card rounded-xl border border-border p-6">
              <h2 className="text-sm font-semibold text-foreground mb-3">Personal Details</h2>
              ...
              <InfoRow label="Location" value={profile.city} />
            </div>

            <div className="bg-card rounded-xl border border-border p-6">
              <h2 className="text-sm font-semibold text-foreground mb-3">Family Details</h2>
